...
echo_and_run cd "/home/mike/code/mikefunpython/cws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/mike/code/mikefunpython/cws/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/mike/code/mikefunpython/cws/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
