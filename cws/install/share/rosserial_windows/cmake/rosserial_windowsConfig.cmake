...
if("FALSE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/mike/code/mikefunpython/cws/src/rosserial/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/mike/code/mikefunpython/cws/devel)
  ...
  set(rosserial_windows_INSTALL_PREFIX /home/mike/code/mikefunpython/cws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mike/code/mikefunpython/cws/install/${idir}'.  Ask the maintainer 'Kareem Shehata <kshehata@clearpathrobotics.com>' to fix it.")
    endif()
